...
const courses = [
  { title:"CIS-Discovery / RISCO", code:"DISCO", slug:"cis-discovery", desc:"Real exam-style questions with full Discovery and RISCO coverage across all domains", longDesc:"Prepare for the ServiceNow CIS-Discovery certification with 173 real exam-style practice questions. Covers all Discovery and RISCO domains including horizontal discovery, service mapping patterns, MID Server configuration, and credential management. Every answer links to official ServiceNow documentation.", rating:4.9, ratings:261, q:173, badge:"best", price:9.99, orig:84.99, track:"infra", ref:"https://www.udemy.com/course/pass-your-servicenow-cis-discovery-exam-vancouver-2023/?referralCode=752D974C366D4DEBE963", keywords:"CIS-Discovery, RISCO, ServiceNow Discovery practice test, CIS-Discovery exam prep, horizontal discovery, MID Server, credential management" },
  { title:"Certified Application Developer", code:"CAD", slug:"cad", desc:"325 questions covering every CAD exam domain with detailed explanations", longDesc:"Master the ServiceNow Certified Application Developer (CAD) exam with 325 practice questions. Covers scripting, UI policies, business rules, client scripts, flow designer, and application scoping. Each question includes sourced explanations linked to official docs.", rating:4.5, ratings:208, q:325, badge:null, price:9.99, orig:84.99, track:"dev", ref:"https://www.udemy.com/course/pass-your-servicenow-cad-exam/?referralCode=CF61F2B36C7F02F40EFB", keywords:"CAD, Certified Application Developer, ServiceNow CAD practice test, CAD exam prep, ServiceNow scripting, business rules, client scripts" },
  { title:"CIS Hardware Asset Mgmt", code:"HAM", slug:"cis-ham", desc:"Full HAM coverage with per-option reasoning for every question", longDesc:"Prepare for the ServiceNow CIS-HAM certification with 240 practice questions covering hardware asset management lifecycle, asset tasks, stockrooms, model categories, and HAM workspace. Every answer option is explained with links to official documentation.", rating:5.0, ratings:1, q:240, badge:"new", price:9.99, orig:84.99, track:"asset", ref:"https://www.udemy.com/course/pass-servicenow-cis-hardware-asset-management-ham/?referralCode=58ECB1F51A94EC5A7F09", keywords:"CIS-HAM, Hardware Asset Management, ServiceNow HAM practice test, HAM exam prep, asset lifecycle, stockroom management" },
  { title:"CIS Risk & Compliance GRC/IRM", code:"GRC", slug:"cis-grc-irm", desc:"300 questions on Entities, Risk, Compliance, and all IRM exam areas", longDesc:"Ace the ServiceNow CIS-Risk and Compliance (GRC/IRM) exam with 300 practice questions. Covers entity management, risk assessment, compliance management, policy lifecycle, audit management, and all IRM exam domains. Sourced explanations for every answer.", rating:4.0, ratings:null, q:300, badge:null, price:9.99, orig:84.99, track:"risk", ref:"https://www.udemy.com/course/pass-servicenow-cis-risk-and-compliance-grc-irm-rc/?referralCode=BAC69ADCBF13729F4018", keywords:"CIS-RC, GRC, IRM, Risk and Compliance, ServiceNow GRC practice test, IRM exam prep, risk assessment, compliance management" },
  ...
  { title:"CIS Field Service Mgmt", code:"FSM", slug:"cis-fsm", desc:"264 FSM questions formatted to match actual exam structure", longDesc:"Pass the ServiceNow CIS-Field Service Management exam with 264 practice questions. Covers work order management, dispatch, scheduling, crew operations, and mobile agent. Every question matches the actual exam format with sourced explanations.", rating:4.5, ratings:31, q:264, badge:null, price:9.99, orig:84.99, track:"service", ref:"https://www.udemy.com/course/pass-servicenow-cis-field-service-mangement-fsm/?referralCode=411E2ADCD2ACF3DE5FC7", keywords:"CIS-FSM, Field Service Management, ServiceNow FSM practice test, FSM exam prep, work order management, dispatch scheduling" },
  { title:"CIS Security Incident Response", code:"SIR", slug:"cis-sir", desc:"All SIR exam topics with clear reasoning per answer choice", longDesc:"Prepare for the ServiceNow CIS-Security Incident Response exam with 281 practice questions. Covers security incidents, threat intelligence, observables, SIEM integration, and security playbooks. Clear reasoning for every answer choice with official doc links.", rating:5.0, ratings:17, q:281, badge:null, price:9.99, orig:84.99, track:"security", ref:"https://www.udemy.com/course/pass-servicenow-cis-security-incident-response-sir/?referralCode=FF6F1DFCBBA2F3C7188D", keywords:"CIS-SIR, Security Incident Response, ServiceNow SIR practice test, SIR exam prep, threat intelligence, security playbooks" },
  { title:"CIS Strategic Portfolio Mgmt", code:"SPM", slug:"cis-spm", desc:"Full SPM coverage with exam-realistic question structure", longDesc:"Master the ServiceNow CIS-Strategic Portfolio Management exam with 350 practice questions. Covers demand management, project portfolios, resource management, and investment funding. Exam-realistic question structure with sourced explanations.", rating:5.0, ratings:13, q:350, badge:"high", price:9.99, orig:84.99, track:"service", ref:"https://www.udemy.com/course/pass-your-servicenow-cis-strategic-portfolio-management-spm/?referralCode=D08240CA36DE435A8CD0", keywords:"CIS-SPM, Strategic Portfolio Management, ServiceNow SPM practice test, SPM exam prep, demand management, project portfolios" },
  ...
  { title:"CIS Customer Service Mgmt", code:"CSM", slug:"cis-csm", desc:"340 questions on 30+ CSM topics with per-option explanations", longDesc:"Prepare for the ServiceNow CIS-Customer Service Management exam with 340 practice questions covering 30+ CSM topics. Includes case management, agent workspace, customer portal, and service contracts. Per-option explanations with official documentation links.", rating:4.6, ratings:25, q:340, badge:"high", price:9.99, orig:84.99, track:"service", ref:"https://www.udemy.com/course/pass-your-servicenow-cis-customer-service-management-csm/?referralCode=211B4B7795C55DA7281A", keywords:"CIS-CSM, Customer Service Management, ServiceNow CSM practice test, CSM exam prep, case management, agent workspace" },
  ...
  { title:"CSA System Administrator", code:"CSA", slug:"csa", desc:"Full CSA practice test covering all exam objectives", longDesc:"Pass the ServiceNow CSA (Certified System Administrator) exam with 392 comprehensive practice questions. Covers platform overview, user administration, notifications, reporting, service catalog, knowledge management, and all CSA exam domains. Sourced explanations for every answer.", rating:4.5, ratings:2, q:392, badge:null, price:9.99, orig:84.99, track:"core", ref:"https://www.udemy.com/course/pass-your-servicenow-csa-certified-system-administrator/?referralCode=2AE0DFA7BE468BCA8888", keywords:"CSA, Certified System Administrator, ServiceNow CSA practice test, CSA exam prep, system administrator certification, ServiceNow admin" },
  { title:"CIS Service Mapping", code:"SM", slug:"cis-service-mapping", desc:"270 Service Mapping questions with explanation for every choice", longDesc:"Prepare for the ServiceNow CIS-Service Mapping exam with 270 practice questions. Covers service mapping patterns, top-down discovery, connection attributes, traffic-based discovery, and map reliability. Every answer choice explained with official doc links.", rating:4.2, ratings:27, q:270, badge:null, price:9.99, orig:84.99, track:"infra", ref:"https://www.udemy.com/course/pass-servicenow-cis-service-mapping-sm-exam/?referralCode=E4C8DC2D2F2DDEEA86D5", keywords:"CIS-SM, Service Mapping, ServiceNow Service Mapping practice test, SM exam prep, top-down discovery, traffic-based discovery" },
  { title:"CIS Software Asset Mgmt", code:"SAM", slug:"cis-sam", desc:"220 SAM questions aligned to the latest exam blueprint", longDesc:"Pass the ServiceNow CIS-Software Asset Management exam with 220 practice questions aligned to the latest blueprint. Covers software models, entitlements, license calculations, SAM workspace, and normalization. Detailed explanations sourced to official docs.", rating:4.8, ratings:50, q:220, badge:"high", price:9.99, orig:84.99, track:"asset", ref:"https://www.udemy.com/course/pass-your-servicenow-cis-software-asset-mgmt-sam-exam/?referralCode=627AA3E200F1159EDF94", keywords:"CIS-SAM, Software Asset Management, ServiceNow SAM practice test, SAM exam prep, license management, software normalization" },
  { title:"CAS Performance Analytics", code:"PA", slug:"cas-pa", desc:"PA certification prep covering reports, indicators, and dashboards", longDesc:"Master the ServiceNow CAS-Performance Analytics exam with 216 practice questions. Covers indicators, breakdowns, analytics hubs, dashboards, scheduled data collections, and reporting best practices. Each answer includes sourced explanations.", rating:4.0, ratings:1, q:216, badge:null, price:9.99, orig:84.99, track:"dev", ref:"https://www.udemy.com/course/pass-your-servicenow-cas-pa-exam/?referralCode=A8ACE29CC7E537680674", keywords:"CAS-PA, Performance Analytics, ServiceNow PA practice test, PA exam prep, indicators, dashboards, analytics hub" },
  ...
  { title:"CIS IT Service Management", code:"ITSM", slug:"cis-itsm", desc:"ITSM practice test with detailed breakdowns per question", longDesc:"Pass the ServiceNow CIS-ITSM exam with 198 practice questions covering incident management, problem management, change management, and all ITSM exam domains. Each question includes a detailed breakdown explaining why each answer option is correct or incorrect.", rating:4.2, ratings:17, q:198, badge:null, price:9.99, orig:84.99, track:"core", ref:"https://www.udemy.com/course/pass-your-servicenow-cis-itsm-exam/?referralCode=3D0B3C1C48CE64275156", keywords:"CIS-ITSM, IT Service Management, ServiceNow ITSM practice test, ITSM exam prep, incident management, change management" },
  { title:"CIS Third-Party Risk Mgmt", code:"TPRM", slug:"cis-tprm", desc:"Full TPRM coverage with 100+ questions and growing", longDesc:"Prepare for the ServiceNow CIS-Third Party Risk Management exam with 180 practice questions. Covers third-party lifecycle, risk assessments, vendor tiering, engagements, and compliance tracking. Sourced explanations for every answer with official documentation links.", rating:4.5, ratings:null, q:180, badge:"new", price:9.99, orig:84.99, track:"risk", ref:"https://www.udemy.com/course/pass-servicenow-cis-third-party-risk-management-tprm/?referralCode=D6DDF7F1E21D051B5047", keywords:"CIS-TPRM, Third-Party Risk Management, ServiceNow TPRM practice test, TPRM exam prep, vendor risk assessment, third-party lifecycle" },
];
